      ...
      unsigned type, size_t idx)
{
   ...
   static const sublabel_enum_map_t sublabel_map[] = {
      ...
      { MENU_ENUM_LABEL_AI_SERVICE_TOGGLE, MENU_ENUM_SUBLABEL_AI_SERVICE_TOGGLE },
      { MENU_ENUM_LABEL_AI_SERVICE_URL, MENU_ENUM_SUBLABEL_AI_SERVICE_URL },
      { MENU_ENUM_LABEL_AI_SERVICE_MODEL, MENU_ENUM_SUBLABEL_AI_SERVICE_MODEL },
      { MENU_ENUM_LABEL_AI_SERVICE_REASONING_EFFORT, MENU_ENUM_SUBLABEL_AI_SERVICE_REASONING_EFFORT },
      { MENU_ENUM_LABEL_AI_SERVICE_API_KEY, MENU_ENUM_SUBLABEL_AI_SERVICE_API_KEY },
